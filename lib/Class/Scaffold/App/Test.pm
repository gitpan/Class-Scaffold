...
Class::Scaffold::App::Test - large-scale OOP application support

=head1 SYNOPSIS

    Class::Scaffold::App::Test->new;
...
Class::Scaffold::App::Test inherits from
...
This document describes version 0.04 of L<Class::Scaffold::App::Test>.
