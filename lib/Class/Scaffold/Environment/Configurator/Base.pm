package Class::Scaffold::Environment::Configurator::Base;
...
Class::Scaffold::Environment::Configurator::Base - large-scale OOP application support

=head1 SYNOPSIS

    Class::Scaffold::Environment::Configurator::Base->new;
...
Class::Scaffold::Environment::Configurator::Base inherits from
...
This document describes version 0.05 of L<Class::Scaffold::Environment::Configurator::Base>.
