package Class::Scaffold::Environment::Configurator::Getopt;
...
Class::Scaffold::Environment::Configurator::Getopt - large-scale OOP application support

=head1 SYNOPSIS

    Class::Scaffold::Environment::Configurator::Getopt->new;
...
Class::Scaffold::Environment::Configurator::Getopt inherits from
...
This document describes version 0.03 of L<Class::Scaffold::Environment::Configurator::Getopt>.
