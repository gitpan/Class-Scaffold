...
Class::Scaffold::Exception::Business - large-scale OOP application support

=head1 SYNOPSIS

    Class::Scaffold::Exception::Business->new;
...
Class::Scaffold::Exception::Business inherits from
...
This document describes version 0.03 of L<Class::Scaffold::Exception::Business>.
