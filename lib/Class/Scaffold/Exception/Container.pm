...
Class::Scaffold::Exception::Container - large-scale OOP application support

=head1 SYNOPSIS

    Class::Scaffold::Exception::Container->new;
...
Class::Scaffold::Exception::Container inherits from
L<Error::Hierarchy::Container> and L<Class::Scaffold::Storable>.
...
This document describes version 0.05 of L<Class::Scaffold::Exception::Container>.
