...
Class::Scaffold::Test::Inherited - large-scale OOP application support

=head1 SYNOPSIS

    Class::Scaffold::Test::Inherited->new;
...
Class::Scaffold::Test::Inherited inherits from L<Class::Scaffold::Base>.
...
This document describes version 0.05 of L<Class::Scaffold::Test::Inherited>.
