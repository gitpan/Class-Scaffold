...
Class::Scaffold::YAML::Active::Array - large-scale OOP application support

=head1 SYNOPSIS

    Class::Scaffold::YAML::Active::Array->new;
...
Class::Scaffold::YAML::Active::Array inherits from
L<Class::Scaffold::Storable> and L<YAML::Active::Plugin::Array>.
...
The superclass L<YAML::Active::Plugin::Array> defines these methods and
functions:

    __array(), __array_clear(), __array_count(), __array_index(),
    __array_pop(), __array_push(), __array_set(), __array_shift(),
    __array_splice(), __array_unshift(), clear___array(), count___array(),
    index___array(), pop___array(), push___array(), run_plugin(),
    set___array(), shift___array(), splice___array(), unshift___array()
...
This document describes version 0.05 of L<Class::Scaffold::YAML::Active::Array>.
