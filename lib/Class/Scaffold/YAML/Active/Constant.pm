...
Class::Scaffold::YAML::Active::Constant - large-scale OOP application support

=head1 SYNOPSIS

    Class::Scaffold::YAML::Active::Constant->new;
...
Class::Scaffold::YAML::Active::Constant inherits from
...
This document describes version 0.03 of L<Class::Scaffold::YAML::Active::Constant>.
