...
Class::Scaffold::YAML::Active::Environment - large-scale OOP application support

=head1 SYNOPSIS

    Class::Scaffold::YAML::Active::Environment->new;
...
Class::Scaffold::YAML::Active::Environment inherits from
...
This document describes version 0.05 of L<Class::Scaffold::YAML::Active::Environment>.
