...
Class::Scaffold::YAML::Active::Exception - large-scale OOP application support

=head1 SYNOPSIS

    Class::Scaffold::YAML::Active::Exception->new;
...
Class::Scaffold::YAML::Active::Exception inherits from
...
This document describes version 0.05 of L<Class::Scaffold::YAML::Active::Exception>.
