...
Class::Scaffold::YAML::Active::ExceptionContainer - large-scale OOP application support

=head1 SYNOPSIS

    Class::Scaffold::YAML::Active::ExceptionContainer->new;
...
Class::Scaffold::YAML::Active::ExceptionContainer inherits from
L<Class::Scaffold::YAML::Active>.
...
This document describes version 0.03 of L<Class::Scaffold::YAML::Active::ExceptionContainer>.
