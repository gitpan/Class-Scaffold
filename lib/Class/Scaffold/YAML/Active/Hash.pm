...
Class::Scaffold::YAML::Active::Hash - large-scale OOP application support

=head1 SYNOPSIS

    Class::Scaffold::YAML::Active::Hash->new;
...
Class::Scaffold::YAML::Active::Hash inherits from
L<Class::Scaffold::Storable> and L<YAML::Active::Plugin::Hash>.
...
The superclass L<YAML::Active::Plugin::Hash> defines these methods and
functions:

    __hash(), __hash_clear(), __hash_delete(), __hash_exists(),
    __hash_keys(), __hash_values(), clear___hash(), delete___hash(),
    exists___hash(), get_args(), keys___hash(), run_plugin(),
    values___hash()
...
This document describes version 0.05 of L<Class::Scaffold::YAML::Active::Hash>.
